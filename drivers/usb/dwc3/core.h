...
#define DWC3_GUSB2PHYCFG_TOUTCAL(n)	(n & 7)
#define DWC3_GUSB2PHYCFG_TOUTCAL_MASK	DWC3_GUSB2PHYCFG_TOUTCAL(0x7)
...
#if defined(__UBOOT__) && (CONFIG_IS_ENABLED(DM_USB) || CONFIG_IS_ENABLED(DM_USB_GADGET))
	struct udevice		*dev;
#else
	struct device		*dev;
#endif
